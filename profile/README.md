![Helping businesses improve their Discord community](https://raw.githubusercontent.com/danieljeongorg/danieljeongorg/main/header.jpg)
...
Find out why your server isn't working. We audit your structure, moderation, onboarding, and engagement, and you get a written action plan. Start with the [free community analysis](https://danieljeong.org/free-analysis), delivered within 24 hours.

### [Hire a Discord Community Manager](https://danieljeong.org/hire-discord-community-manager)

Ongoing management by an operator who has grown a server past a million members. Strategy, engagement programs, moderation coverage, and reporting, from $1,500 to $15,000+ per month depending on scope.

### [Discord Server Setup Service](https://danieljeong.org/discord-server-setup-service)

Professional server builds for businesses, not $10 gigs. Architecture, roles, onboarding flows, safety systems, and branded embeds, from $500.

### [Discord Moderation Service](https://danieljeong.org/discord-moderation-service)

AutoMod regex, anti-raid, verification gates, and spam and scam filters, set up from $750. Your server stays clean, even at 2am.

### [Discord Engagement Service](https://danieljeong.org/discord-engagement-service)
...
Every engagement starts the same way: we look at your server and tell you what is actually happening inside it. The [free community analysis](https://danieljeong.org/free-analysis) comes back within 24 hours. No pitch, no pressure.
